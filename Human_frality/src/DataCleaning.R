yield_data <- read.csv("D:/PDS/Bhavana/Human_frality/data_raw/raw_yield_data.csv")
clean_yield_data<-na.omit(yield_data[yield_data != "N", ])
write.csv(clean_yield_data,"D:/PDS/Bhavana/Human_frality/data_clean/clean_yield_data.csv")
...
Summ
capture.output(Summ,file="D:/PDS/Bhavana/Human_frality/results/summary.txt")
